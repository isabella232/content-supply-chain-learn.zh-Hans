---
title: 营销敏捷性 — 使非创意人员能够扩展
description: 查看Adobe内容供应链教程，有时，无需完整的创意团队/工作室处理即可处理内容请求。 Adobe将各种工具交到营销人员和其他潜在内容创建者手中，以便能够快速开启创建内容变体和更新的过程，进而让更多连接到内容供应链的个人（范围更广）能够快速完成这些过程，从而大幅提高内容吞吐量和上市时间。
...
使用Adobe内容供应链工具，有时无需整个创意团队/工作室处理即可处理内容请求。 Adobe将工具交到营销人员和其他潜在内容创建者手中。 使用这些工具可以快速启用创建内容变体。 更新可以由连接到内容供应链的规模更大、范围更广的个人执行，从而大大增加了内容吞吐量和上市时间。
...
<div class="columns is-multiline"><div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Using Smart Crop with AEM Assets Dynamic Media" tabIndex="0">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/smart-crop-feature-video-use.html" title="在AEM Assets Dynamic Media中使用智能裁切" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/21519?format=jpeg" alt="在AEM Assets Dynamic Media中使用智能裁切">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/smart-crop-feature-video-use.html" title="在AEM Assets Dynamic Media中使用智能裁切">在AEM Assets Dynamic Media中使用智能裁切</a>
          </p>
          <p class="is-size-6"><em>智能裁切使用Adobe Sensei来消除为响应式设计裁切内容这一耗时且成本高昂的任务。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-social-posters.html" title="使用Firefly创建社交海报" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-webinar-poster.html" title="使用Firefly创建网络研讨会海报" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-blog-graphics.html" title="轻松运行社交营销活动" tabindex="-1">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-blog-graphics.html" title="轻松运行社交营销活动">轻松运行社交营销活动</a>
          </p>
          <p class="is-size-6"><em>了解如何使用由Adobe Firefly提供支持的“文本到图像”功能，为Web、博客和社交营销活动创建独特的图形内容。 本教程使用新Adobe Express。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>了解如何在Adobe Express中使用由Adobe Firefly提供支持的文本到图像，为员工招聘和入门培训内容创建独特的图形。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="使用Firefly为营销活动创建传单内容" tabindex="-1">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="使用Firefly为营销活动创建传单内容">使用Firefly为营销活动创建传单内容</a>
          </p>
          <p class="is-size-6"><em>了解如何在Adobe Express中使用由Adobe Firefly提供支持的文本到图像功能，以通过全球酒店营销活动创建本地化内容。 </em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>了解商业团队如何在其在线商店中为新库存集轻松创建引人注目的图像。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html" title="使营销团队能够创建多渠道内容" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3424446?format=jpeg" alt="使营销团队能够创建多渠道内容">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html" title="使营销团队能够创建多渠道内容">使营销团队能够创建多渠道内容</a>
          </p>
          <p class="is-size-6"><em>了解事件营销团队如何创建独特内容来吸引在线事件的查看者。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>了解如何在Adobe Express中使用简单易用的集成设计工具来创建具有专业外观的PDF。 本视频教程使用新的工作区体验。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/content-automation/overview.html" title="使用Content Services实现Creative Cloud自动化概述" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/333197?format=jpeg" alt="使用Content Services实现Creative Cloud自动化概述">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
